...
public class Varify {
    ...
    public static boolean chk_length_max(JFormattedTextField jf, int length, String field, JLabel error) {
     ...
     public static boolean chk_isComboboxSelected(JComboBox jf,String 
         field, JLabel error){
    ...
    public static boolean chk_dateCombobox(JComboBox day,JComboBox month,JComboBox year,String 
         field, JLabel error){
