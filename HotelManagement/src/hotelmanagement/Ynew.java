 ...
 * @author SABER
 */
public class Ynew extends javax.swing.JDialog {
    String s,t;
static boolean isNew;
    Object[][] data;
    /**
     * Creates new form Ynew
     */
    public Ynew(java.awt.Frame parent, boolean modal,boolean isN) {
        super(parent, modal);
        initComponents();
        isNew = isN;
        ...
        if (isNew == true) {
            ...
            String sql = "SELECT count(YEAR) FROM manager.YEARPROFIT where YEAR='" + Yearlyprofit.selecteditem3 + "'";
            int count = Utility2.countQuery(rootPane, sql);
            System.out.println(count);
            data = new Object[count][5];
            String sq = "select year,accountant,PROFIT,EXPEND,TOTAL_PROFIT from manager.yearprofit where year='" + Yearlyprofit.selecteditem3 + "' ";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (isNew == false) {
            sql = "INSERT INTO manager.yearprofit VALUES('" + date1.getText() + "','" + date2.getText() + "','" + date3.getText() + "','" + date4.getText() + "','" + date5.getText()+ "')";
            Utility2.insertUpdateQuery(sql, rootPane, 1);


        } else {
            sql = "update manager.yearprofit set year='" + date1.getText() + "',accountant='" + date2.getText() + "',profit='" + date3.getText() + "',expend='" + date4.getText() + "',total_profit='" + date5.getText()+ "'"
                    + "where YEAR ='" + Yearlyprofit.selecteditem3 + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ynew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Ynew dialog = new Ynew(new javax.swing.JFrame(), true,true);
