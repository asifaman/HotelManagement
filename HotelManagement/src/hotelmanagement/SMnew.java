...
public class SMnew extends javax.swing.JDialog {
 ...
 Object[][] data;
    ...
    /**
     * Creates new form SMnew
     */
    public SMnew(java.awt.Frame parent, boolean modal,boolean isN) {
        super(parent, modal);
        initComponents();
        isNew = isN;
        ...
        if (isNew == true) {
            ...
            String sql = "SELECT count(id) FROM manager.sm where id='" + SM.selecteditem3 + "'";
            int count = Utility2.countQuery(rootPane, sql);
            System.out.println(count);
            data = new Object[count][5];
            String sq = "select id,name,desig,salary,paid from manager.sm where id='" + SM.selecteditem3 + "' ";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (isNew == false) {
            ...
            sql = "update manager.sm set id='" + date1.getText() + "',name='" + date2.getText() + "',desig='" + date3.getText() + "',salary='" + date4.getText() + "',paid='" + date5.getText()+ "'"
                    + "where id ='" + SM.selecteditem3 + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SMnew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                SMnew dialog = new SMnew(new javax.swing.JFrame(), true,true);
