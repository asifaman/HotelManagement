 ...
 * @author SABER
 */
public class Mnew extends javax.swing.JDialog {
    String s,t;
static boolean isNew;
    Object[][] data;
    /**
     * Creates new form Mnew
     */
    public Mnew(java.awt.Frame parent, boolean modal,boolean isN) {
        super(parent, modal);
        initComponents();
        isNew = isN;
        ...
        if (isNew == true) {
            ...
            String sql = "SELECT count(MONTH) FROM manager.monthprofit where MONTH='" + Monthlyprofit.selecteditem3 + "'";
            int count = Utility2.countQuery(rootPane, sql);
            System.out.println(count);
            data = new Object[count][5];
            String sq = "select MONTH,YEAR,PROFIT,EXPEND,TOTAL_PROFIT from manager.MONTHPROFIT where MONTH='" + Monthlyprofit.selecteditem3 + "' ";
    ...
    //Mnew(Monthlyprofit aThis, boolean b, boolean b0) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if (date1.getText().isEmpty() || date2.getText().isEmpty()) {
        ...
        if (isNew == false) {
            sql = "INSERT INTO manager.monthprofit VALUES('" + date1.getText() + "','" + date2.getText() + "','" + date3.getText() + "','" + date4.getText() + "','" + date5.getText()+ "')";
            Utility2.insertUpdateQuery(sql, rootPane, 1);


        } else {
            sql = "update manager.monthprofit set month='" + date1.getText() + "',year='" + date2.getText() + "',profit='" + date3.getText() + "',expend='" + date4.getText() + "',total_profit='" + date5.getText()+ "'"
                    + "where month ='" + Monthlyprofit.selecteditem3 + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mnew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Mnew dialog = new Mnew(new javax.swing.JFrame(), true,true);
